...
export function SettingsScreen() {
  ...
  async function handleRecoverAccount() {
    try {
      await recoverAccount(recoveryEmail.trim());
  ...
  return (
    <Screen title={t("screens.settings.title")} subtitle={t("screens.settings.subtitle")}>
      ...
      <Card>
        ...
        <Text style={styles.syncText}>{isOnline ? t("screens.settings.online") : t("screens.settings.offline")}</Text>
        <Text style={styles.syncText}>{t("screens.settings.pendingActions", { count: pendingActionsCount })}</Text>
      </Card>
