...
TELEGRAM_AUDIT_ALERTS_ENABLED = _env_bool("TELEGRAM_AUDIT_ALERTS_ENABLED", False)
TELEGRAM_AUDIT_BOT_TOKEN = os.getenv("TELEGRAM_AUDIT_BOT_TOKEN", "").strip()
TELEGRAM_AUDIT_CHAT_ID = os.getenv("TELEGRAM_AUDIT_CHAT_ID", "").strip()
AUDIT_RETENTION_DAYS_DEFAULT = int(os.getenv("AUDIT_RETENTION_DAYS_DEFAULT", "90"))
