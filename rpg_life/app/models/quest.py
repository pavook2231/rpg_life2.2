...
class Quest(Base):
    ...
    quest_code = Column(String, nullable=True, index=True)
    phase_code = Column(String, nullable=True, index=True)
    is_required = Column(Boolean, default=False)
    is_repeatable = Column(Boolean, default=False)
    quest_state = Column(String, default="available", index=True)
